...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) { // solium-disable-line no-empty-blocks
        // TODO return the token balance of given address
        // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    }

    function ownerOf(uint256 tokenId) public view returns (address) { // solium-disable-line no-empty-blocks
        // TODO return the owner of the given tokenId
    }

//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public { // solium-disable-line no-empty-blocks
    ...
    function getApproved(uint256 tokenId) public view returns (address) { // solium-disable-line no-empty-blocks
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _mint(address to, uint256 tokenId) internal { // solium-disable-line no-empty-blocks
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _transferFrom(address from, address to, uint256 tokenId) internal { // solium-disable-line no-empty-blocks
